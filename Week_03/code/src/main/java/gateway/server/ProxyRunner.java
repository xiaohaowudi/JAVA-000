...
public class ProxyRunner {
    ...
    public void run(ProxyRouter.ProxyRouterType routerType, Map<String, Set<String>> server2uris, Map<String, Integer> server2weight, boolean debug) {
        ...
        try {
            ...
            if (routerType == ProxyRouter.ProxyRouterType.WEIGHT) {
                WeightBasedRouter weightRouter = new WeightRouter();
                ...
                router = debug ? new PrintDispatchInfoWrapper(new RandomRouter()) : new RandomRouter();
            }
            ...
            ProxyReqHandler handler = new ProxyReqHandler(router);
